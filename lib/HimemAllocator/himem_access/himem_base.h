...
typedef struct {
    ...
    size_t (*read)(himem_allocator_t * allocator, const uint16_t block_id, void *buf, const size_t len);
    size_t (*write)(himem_allocator_t * allocator,const uint16_t block_id, const void *buf, const size_t len);
